...
ActiveRecord::Schema.define(version: 20190411041540) do
  ...
  create_table "erp_products_product_images", id: :serial, force: :cascade do |t|
    t.integer "product_id"
    t.string "image_url"
    t.datetime "created_at", default: "2019-09-12 20:12:00", null: false
    t.datetime "updated_at", default: "2019-09-12 20:12:00", null: false
